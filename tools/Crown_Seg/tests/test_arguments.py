...
def test_a_directory_is_not_a_checkpoint(tmp_path, stub_engine):
    """`DATA/CrownSeg/models/` holds one .pth file; naming the folder instead
    of the file is the obvious mistake, and it must not reach shapeaxi."""
    write_surface(tmp_path / "cohort" / "arch.vtk")
